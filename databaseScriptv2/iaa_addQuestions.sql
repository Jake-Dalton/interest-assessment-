...
insert into questions
values (null, 2, 1, 'If you wish to re-partition your computer without losing the operating system or data you will need to use a ______ party application.'),
(null, 2, 1, 'Which event viewer log can monitor attempted intrusions?'),
(null, 2, 1, 'How are users authenticated on a network?'),
(null, 2, 1, 'To capture a screen shot of the active window, hold down the ______ key while pressing the PRINT SCRN key.'),
(null, 2, 1, 'If you wish to re-partition your computer without losing the operating system or data you will need to use a ______ party application.');
